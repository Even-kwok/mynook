...
/**
 * Extracts a descriptive prompt from an image using Gemini.
 * @param base64Image A base64 encoded image string (without the data: prefix).
 * @param customPrompt The user-defined instruction for the extraction.
 * @returns A promise that resolves to the generated prompt string.
 */
export const extractPromptFromImage = async (base64Image: string, customPrompt: string): Promise<string> => {
    try {
