                    ...
                    {allGalleryImages.length > 0 && (
                        <div className="px-2 mb-4 flex-shrink-0">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="w-full px-4 py-3 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white text-sm font-semibold rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl border border-white/20"
                            >
                                    ...
                                    return (
                                        <div key={albumType}>
                                            <motion.button
                                                ...
                                                whileTap={{ scale: 0.99 }}
                                                className="w-full text-left p-3 rounded-2xl bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all duration-200 flex justify-between items-center border border-white/10 shadow-sm"
                                                aria-expanded={isExpanded}
                                            >
                                                <h3 className="font-semibold text-sm text-white">{albumTypeLabels[albumType]} ({imagesInAlbum.length})</h3>
                                                <IconChevronDown className={`w-5 h-5 text-slate-300 transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`} />
                                            </motion.button>
