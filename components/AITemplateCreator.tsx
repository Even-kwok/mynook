    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-8 rounded-xl shadow-sm border-2 border-dashed border-slate-200 hover:border-indigo-300 transition-colors">
        ...
        <div className="text-center">
          ...
          {/* 上传提示 */}
          <div className="mt-6 max-w-xl mx-auto bg-amber-50 border border-amber-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-amber-800 space-y-1">
                ...
                <ul className="list-disc list-inside space-y-1 mt-2">
                  <li>Please upload images with <strong>bright lighting</strong> and <strong>clear details</strong></li>
                  <li>When selecting templates, choose styles <strong>similar to your space design</strong></li>
                </ul>
              </div>
            </div>
          </div>
