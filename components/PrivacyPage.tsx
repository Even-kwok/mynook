            ...
            <div className="max-w-5xl mx-auto px-6 pt-24 pb-12">
                ...
                >
                    ...
                    <div className="space-y-8 text-slate-300">
                        ...
                        {/* Privacy Section */}
                        <section className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-2xl p-8 shadow-sm border-2 border-indigo-500/30">
                            <h2 className="text-3xl font-bold text-white mb-6">Our Commitment to Privacy</h2>
                            
                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Privacy Statement</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Information Gathering</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Information Use</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Information Sharing</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Payment Processing</h3>
                                    <p className="leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Information Protection</h3>
                                    <p className="leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Your Privacy Rights</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Children's Privacy</h3>
                                    <p className="leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Cookies and Tracking</h3>
                                    <p className="leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Data Retention and International Transfers</h3>
                                    <p className="leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-200 mb-3">Changes to Privacy Policy</h3>
                                    <p className="leading-relaxed">
