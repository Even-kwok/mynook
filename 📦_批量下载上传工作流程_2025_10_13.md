...
#### Interior Design
```
style_living-room_modern-minimalist_1728835200000.png
```
解析：
- `type`: `style` (Interior Design 功能)
- `roomTypeId`: `living-room` (Living Room)
- `templateName`: `modern-minimalist` (模板名称)
- `timestamp`: `1728835200000` (生成时间戳)

#### Exterior Design
```
exterior_house_contemporary_1728835300000.png
```
解析：
- `type`: `exterior` (Exterior Design 功能)
- `roomTypeId`: `house` (House 建筑类型)
- `templateName`: `contemporary` (Contemporary 模板)
- `timestamp`: `1728835300000`

#### Garden Design
```
garden_no-room_japanese-zen-garden_1728835400000.png
```
解析：
- `type`: `garden` (Garden Design 功能)
- `roomTypeId`: `no-room` (Garden 没有房间类型)
- `templateName`: `japanese-zen-garden`
- `timestamp`: `1728835400000`
...
// 使用示例
const parsed = parseFileName('style_living-room_modern-minimalist_1728835200000.png');
console.log(parsed);
// {
//   type: 'style',
...
//   originalName: 'style_living-room_modern-minimalist_1728835200000.png'
// }
```
